                                            ...
                                            <div className="px-2 space-y-1">
                                                ...
                                                {role === 'ROLE_ADMIN' && (
                                                    <div className="pt-2 mt-2 border-t border-zinc-800">
                                                        ...
                                                        <Link to="/admin/revenue" onClick={() => setShowUserMenu(false)} className="flex items-center px-4 py-3 hover:bg-emerald-950/20 text-emerald-400 text-sm font-bold rounded-2xl transition">
