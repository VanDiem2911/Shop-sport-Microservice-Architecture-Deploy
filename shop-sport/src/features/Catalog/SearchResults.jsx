  ...
  return (
    <div className="container mx-auto px-6 lg:px-8 py-16">
      ...
      <div className="mb-12 border-b border-gray-100 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <p className="text-xs font-black uppercase text-blue-600 tracking-widest mb-2">Trang tìm kiếm</p>
          <h2 className="text-3xl lg:text-4xl font-black italic tracking-tighter text-gray-900 uppercase">
            Kết quả cho: <span className="text-blue-600">"{query}"</span>
          </h2>
        </div>
        <p className="text-sm font-bold text-gray-500 bg-gray-50 px-4 py-2 rounded-2xl border border-gray-100 flex-shrink-0">
          Tìm thấy <span className="text-blue-600 font-black">{filteredProducts.length}</span> sản phẩm phù hợp
        </p>
      </div>
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-16 px-8 bg-gray-50/50 rounded-[3rem] border border-dashed border-gray-200 mb-16 flex flex-col items-center">
            <div className="w-20 h-20 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mb-6">
              <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <h3 className="text-xl font-black text-gray-800 mb-2 uppercase tracking-wide">Không tìm thấy sản phẩm nào</h3>
            <p className="text-gray-500 max-w-md text-sm leading-relaxed mb-6">
              Chúng tôi không tìm thấy kết quả phù hợp cho từ khóa <span className="font-bold text-gray-900">"{query}"</span>. Bạn hãy thử tìm kiếm bằng các từ khóa khác hoặc tham khảo các gợi ý dưới đây.
            </p>
            
            {/* Gợi ý tìm kiếm */}
            <div className="text-left bg-white p-6 rounded-2xl border border-gray-100 max-w-sm w-full">
              <p className="text-[10px] font-black text-blue-600 uppercase tracking-wider mb-3">Mẹo tìm kiếm:</p>
